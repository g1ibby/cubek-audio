...
Backend-agnostic short-time Fourier transform (STFT) kernels built on
`cubek-fft`. The crate compiles unchanged against any cubecl runtime —
wgpu (Metal / SPIR-V / WGSL), native CUDA, or CPU.
...
For workspace-level test invocations, see the root
[`README.md`](../../README.md).
